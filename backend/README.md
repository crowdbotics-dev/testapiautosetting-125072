...
## Project Structure
    ...
    ├── testapiautosetting_125072  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125072`
...
2. Clone this repo and `cd testapiautosetting_125072`
